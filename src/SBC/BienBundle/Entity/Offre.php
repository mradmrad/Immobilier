...
class Offre implements \JsonSerializable
{
     ...
     * @ORM\JoinColumn(nullable=true, name="proposedby_code", referencedColumnName="code")
     */
     ...
     * Set acceptation
     *
     * @param \SBC\BienBundle\Entity\Acceptation $acceptation
     *
     * @return Offre
     */
    public function setAcceptation(\SBC\BienBundle\Entity\Acceptation $acceptation = null)
    {
