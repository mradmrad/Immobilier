 ...
 * ProprietaireSelf
 *
 * @ORM\Table(name="proprietaire_self")
 * @ORM\Entity(repositoryClass="SBC\BienBundle\Repository\ProprietaireSelfRepository")
 */
class ProprietaireSelf extends Proprietaire
{
